...
- Current branch: `cursor/slice-37-global-concurrency-idempotency-hardening-19d3`
- Current commit (Slice 37 implementation): `1c2dbac05537b0fd2894527b7feae5dda8faaf8a`
...
| Reporting | Partial | Slice 16-17,34-37 | Invoices, Customers, PDF, Audit | TBD | Scope drift into accounting/ledger behavior | Read-only customer statements (JSON/HTML/PDF) are implemented with deterministic filtering and export hardening; Slice 34 adds a shared derived reporting read model for deterministic AR/AP reconciliation, ordering, date filtering, and pagination without materialized reporting tables or ledger persistence; Slice 35 hardens statement read determinism and shared API error contract consistency; Slice 36 verifies reporting parity pre/post restore from recalculated source data; Slice 37 adds concurrency/rollback/idempotency regression coverage proving reporting remains deterministic after concurrent commits and failed transactions. |
