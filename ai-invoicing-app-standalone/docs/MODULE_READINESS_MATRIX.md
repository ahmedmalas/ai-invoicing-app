...
- Current branch: `cursor/slice-35-global-api-contract-integrity-error-determinism-19d3`
- Current commit (Slice 35 implementation): `30a5f603bf8cfeae8cc89823a169caf2da49e2cd`
- Current implemented slice: **Slice 35 — Global API Contract Integrity & Error Determinism**
...
| Reporting | Partial | Slice 16-17,34-35 | Invoices, Customers, PDF, Audit | TBD | Scope drift into accounting/ledger behavior | Read-only customer statements (JSON/HTML/PDF) are implemented with deterministic filtering and export hardening; Slice 34 adds a shared derived reporting read model for deterministic AR/AP reconciliation, ordering, date filtering, and pagination without materialized reporting tables or ledger persistence; Slice 35 hardens statement read determinism and shared API error contract consistency. |
