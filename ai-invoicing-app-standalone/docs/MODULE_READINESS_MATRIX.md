...
- Current branch: `cursor/slice-34-global-reporting-read-model-integrity-19d3`
- Current commit (Slice 34 implementation): `6ae9f56d029218ea2b65cd3232eac955ca39f4d5`
...
| Reporting | Partial | Slice 16-17,34 | Invoices, Customers, PDF, Audit | TBD | Scope drift into accounting/ledger behavior | Read-only customer statements (JSON/HTML/PDF) are implemented with deterministic filtering and export hardening; Slice 34 adds a shared derived reporting read model for deterministic AR/AP reconciliation, ordering, date filtering, and pagination without materialized reporting tables or ledger persistence. |
