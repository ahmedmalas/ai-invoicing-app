...
| AI Assistant | Partial | Aleya AI M1 operating layer | Documents, Preferences, Audit, Policy controls, AI Gateway | Expand tool coverage to quotes/AP/inventory/send-email (M2–M3) | Non-deterministic behavior / provider config risk | Central action registry + multi-step agent + broad M1 tool set shipped; see `docs/ALEYA_AI.md` and `docs/ALEYA_AI_CAPABILITY_MATRIX.md`. |
