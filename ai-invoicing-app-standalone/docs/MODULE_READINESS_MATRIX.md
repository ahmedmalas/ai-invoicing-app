...
- Current branch: `cursor/slice-36-platform-backup-restore-snapshot-integrity-19d3`
- Current commit (Slice 36 implementation): `88ef92b1a5ba4d32c40ff6907ee1a2f8a8b03240`
- Current implemented slice: **Slice 36 — Platform Backup, Restore & Snapshot Integrity**
...
| Reporting | Partial | Slice 16-17,34-36 | Invoices, Customers, PDF, Audit | TBD | Scope drift into accounting/ledger behavior | Read-only customer statements (JSON/HTML/PDF) are implemented with deterministic filtering and export hardening; Slice 34 adds a shared derived reporting read model for deterministic AR/AP reconciliation, ordering, date filtering, and pagination without materialized reporting tables or ledger persistence; Slice 35 hardens statement read determinism and shared API error contract consistency; Slice 36 verifies reporting parity pre/post restore from recalculated source data. |
