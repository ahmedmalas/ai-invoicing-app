...
export function buildAleyaSystemPrompt(options: {
  ...
  return [
    ...
    '- For irreversible / externally visible / financially significant actions, tools will request confirmation. Stop and present one clear confirmation covering the exact high-impact set.',
