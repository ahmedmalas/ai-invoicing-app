...
export const TIMELINE_TAXONOMY: Record<TimelineEventKey, TimelineTaxonomyDefinition> = {
  ...
  'invoice.draft_deleted': {
    key: 'invoice.draft_deleted',
    version: 1,
    category: 'invoice',
    entityType: 'invoice',
    actorType: 'system',
    source: 'api',
    payloadSchema: 'timeline.invoice.draft_deleted.v1',
    legacyEventType: 'Draft Deleted',
  },
  'invoice.finalised': {
  ...
  'customer.deleted': {
    ...
    actorType: 'system',
    source: 'api',
    payloadSchema: 'timeline.customer.deleted.v1',
    legacyEventType: 'Customer Deleted',
  },
  'business_profile.updated': {
